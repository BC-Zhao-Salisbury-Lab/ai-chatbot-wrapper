...
export async function POST(req) {
  try {
    ...
    const systemInstruction = condition === 'advisor'
      ...
      Before making initial recommendations, ask at least one question about the participant's travel preferences, goals, or interests so your advice is tailored to what they value. But be sure to give some sort of recommendation after at most 3 questions.
      ...
      Before making initial recommendations, ask at least one question about the participant's logistical needs or planning constraints (such as budget, travel dates, transportation, accommodations, or schedule) so your assistance is tailored to their trip. But be sure to give some sort of recommendation after at most 3 questions.
